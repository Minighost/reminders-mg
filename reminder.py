...
class ReminderApp(tk.Tk):
    def __init__(self):
        ...
        self._build_ui()
        self._pending: list[dict] = []  # active reminders

    # Layout
    def _build_ui(self):
        now = datetime.datetime.now()

        # helpers for packing frames
        # maybe grid() is better than pack()? idk
        def row(pady=(4, 0)):
            f = tk.Frame(self)
    ...
    def _on_set(self):
        ...
        # update status, affects window immediately
    ...
    def _refresh_list(self):
        ...
        self.list_var.set(items)  # also affects window immediately
